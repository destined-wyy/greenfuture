...
const routes = [
    //前台
  {
    ...
    meta: {title:'绿色未来GreenFuture', path: '绿色未来GreenFuture', requireAuth: false},
    children: [
      {path: 'person', name: 'person', meta: {title:'个人信息',requireLogin: true}, component: () => import('../views/Person.vue'),},
      {path: 'topview', name: 'topview', meta: {title:'绿色未来GreenFuture'}, component: () => import('../views/front/TopView.vue'),},
